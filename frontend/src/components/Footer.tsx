		...
		<footer className="bg-background_alt p-6">
			<div className="flex flex-col text-primary">
				<div className="flex flex-row items-center justify-between">
					<a href="https://github.com/keatsane/big-project-4331" target="_blank" rel="noopener noreferrer">
						<svg className="h-8 w-8 fill-primary hover:fill-tertiary transition-all" viewBox="0 0 24 24">
				...
				<div className="border-t border-primary pt-8 mt-8 mb-4">
					<div className="flex flex-row items-center justify-between">
						<div className="flex flex-row items-center gap-4">
							<svg xmlns="http://www.w3.org/2000/svg" height="31.275" viewBox="0 0 250 200.84505" width="37.5">
							...
							<p className="text-xs leading-5">2024 COP-4331. Big Project. Team 2.</p>
						</div>
