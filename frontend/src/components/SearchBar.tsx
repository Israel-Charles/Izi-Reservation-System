...
const SearchBar = () => {
    ...
    return (
        <div className="container mx-auto -mt-8 lg:-mb-[25px] px-6 z-10">
            <form
                onSubmit={handleSubmit}
                className="p-3 bg-background_alt rounded shadow-sm grid grid-cols-2 lg:grid-cols-4 items-center gap-4 "
            >
