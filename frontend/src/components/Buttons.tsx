...
export const SignOutButton = () => {
	...
	return (
		<button
			onClick={handleClick}
			className="text-primary px-3 py-2 font-bold bg-med_orange hover:bg-dark_orange">
			Sign Out
		</button>
	);
};
...
export const ThemeButton = () => {
	return (
		<button
			className={`p-2 text-primary hover:bg-primary hover:text-med_orange rounded-lg transition-all`}>
			{/* {theme === "light" ? ( */}
			<svg
